...
<body>
    ...
    <p>Thank you for submitting your Farm Mechanization Request. We have received your request and will get in touch
        with you soon. You can further access the status of your request through this<a
            href="{{ config('app.url') }}/farmmechanization/tracksearchlink?tracking_number={{ $data['transaction_number'] }}">
            link
        </a></p>
