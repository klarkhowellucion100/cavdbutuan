<x-userlayout.layout>
                            ...
                            <form id="availabilityform" method="POST">
                                ...
                                <div class="d-flex gap-2">
                                    <a type="button" class="btn btn-success"
                                        href="{{ route('farmmechanization.user.availability.create') }}">Create</a>
    ...
    <script>
        ...
        document.getElementById('confirmDeleteBtn').addEventListener('click', function() {
            ...
            form.action = "{{ route('farmmechanization.user.availability.bulkdelete') }}";
            form.submit();
        });
        ...
        document.getElementById('confirmDisableBtn').addEventListener('click', function() {
            const form = document.getElementById('availabilityform');
            form.action = "{{ route('farmmechanization.user.availability.bulkdisable') }}";
            form.submit();
        });
        ...
        document.getElementById('confirmEnableBtn').addEventListener('click', function() {
            const form = document.getElementById('availabilityform');
            form.action = "{{ route('farmmechanization.user.availability.bulkenable') }}";
            form.submit();
        });
