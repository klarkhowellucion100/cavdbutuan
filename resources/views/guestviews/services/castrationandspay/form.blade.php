                ...
                <div id="content" style="border: 1px solid #357ae8; padding: 10px; width: 100%;">
                    ...
                    <div class="row">
                        <div class="col-lg-12 text-center">
                            <h3 class="text-primary" style="font-weight:bold;">Castration and Spay Service Request Slip
                            </h3>
                        ...
                        <div class="row">
                                        ...
                                        <div style="font-weight:bold;">Service Status:
                                            <span class="text-primary">
                                                @if ($record->request_status === 0)
                                                    <span class="text-warning" style="font-weight:bold">Scheduled
                                                    </span>
                                                @elseif ($record->request_status === 1)
                                                    <span class="text-success" style="font-weight:bold">Served
                                                    </span>
                                                @endif
                                            </span>
                                        </div>
                                    ...
                                    <table class="table table-bordered">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="align-middle">{{ $record->service_type }}
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="align-middle table-active text-primary"
                                                ...
                                                <td class="align-middle">{{ $record->animal_type }}
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="align-middle table-active text-primary"
                                                ...
                                                <td class="align-middle">
                                                    Year: {{ $record->animal_age_year }}
                                                    <br>
                                                    Month: {{ $record->animal_age_month }}
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="align-middle table-active text-primary"
                                                ...
                                                <td class="align-middle">{{ $record->animal_specie }}
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="align-middle table-active text-primary"
                                                ...
                                                <td class="align-middle">{{ $record->animal_sex }}
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="align-middle table-active text-primary"
                            ...
                            <div class="col-lg-12">
                                <div class="text-large pt-3" style="font-style: italic;"><span
                                        ...
                                        <span
                                            ...
                                            Securing the booking is FREE OF CHARGE, and Castration and Spay Service
                                            Request
                                            Slip in
                                            NON-TRANSFERABLE.
                                            <br>
                                            <span class="text-primary fw-bold" style="font-weight:bold;">
                                                - Libre ang pagpa-book, ug ang Castration and Spay Service Request Slip
                                                dili
                                                puwede
                            ...
                            <div class="col-lg-12">
                                <div class="text-large pt-3" style="font-style: italic;"><span
                                        ...
                                        <br> <span class="text-primary">(Ubang mga instruksyon):</span></span> <br>
                                    <span
                                        style="display: block; padding-left: 20px; text-indent: -20px; margin-left: 20px;">1.
                            ...
                            <div class="col-lg-12">
                                <div class="text-large" style="font-style: italic; margin-top: -40px;"><span
                                    ...
                                    <span
                                        style="display: block; padding-left: 20px; text-indent: -20px; margin-left: 20px;">1.
                                        Please ensure that the Pre-Operative Instructions were executed and all
                                        materials required from the owner are brought before the
                                        operation can commence.
                                        <br>
                                        <span class="text-primary fw-bold" style="font-weight:bold;">
                                            - Palihug siguroa nga ang tanang naka indikar sa Pre-Operative Instructions
                                            natuman
                                    ...
                                    <span
                                        style="display: block; padding-left: 20px; text-indent: -20px; margin-left: 20px;">2.
                                        Proceed to the City Agriculture and Veterinary Department (CAVD) and present the
                                        Castration and Spay Service Request Slip with your valid ID to the
                                        Information Desk for
                                        validation
                                        <br>
                                        <span class="text-primary fw-bold" style="font-weight:bold;">
                                            - Adto sa City Agriculture and Veterinary Department (CAVD) ug ipakita ang
                                            Castration ug Spay Service Request Slip uban sa imong valid ID sa
                                    ...
                                    <span
                                        style="display: block; padding-left: 20px; text-indent: -20px; margin-left: 20px;">3.
                                        After your documents have been validated, proceed to the Plant and Animal Health
